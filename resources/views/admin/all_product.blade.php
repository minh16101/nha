        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <a onclick="return confirm('Ban co chac se xoa khong?')" href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active" ui-toggle-class="">
    ...
    <footer class="panel-footer">
      <div class="row">
        ...
        <div class="col-sm-5 text-center">
          <small class="text-muted inline m-t-sm m-b-sm">Trang</small>
        </div>
