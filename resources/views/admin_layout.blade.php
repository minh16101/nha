        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-category-product')}}">Thêm </a></li>
						<li><a href="{{URL::to('/all-category-product')}}">Danh sách</a></li>
                 ...
                 <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Các loại thương hiệu</span>
                    </a>
                    <ul class="sub">
